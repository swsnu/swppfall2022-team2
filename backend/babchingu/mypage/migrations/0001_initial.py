    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timeTable', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.BooleanField(default=False), blank=True, size=24), blank=True, size=5)),
